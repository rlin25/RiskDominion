...
- [AI Systems](#ai-systems): AI Opponent, Commander, Consortium, Deliberation Chain, Intel, Intel Threshold, Orchestration, Persona, Prophet, Reasoning Cycle, Specialist, Strategist, Strategist Alert, Subordinate, Zhao
- [Technical Terms](#technical-terms): Claude, Fire-and-Forget, LLM, Reducer, Scheduled Reducer, SpacetimeDB, Subscription, Thread
